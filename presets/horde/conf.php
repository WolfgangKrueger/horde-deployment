...
$conf['use_ssl'] = 2;
$conf['server']['name'] = $_SERVER['HTTP_X_FORWARDED_SERVER'] ?? $_SERVER['SERVER_NAME'];
...
$conf['sql']['hostspec'] = 'b1gws_horde_db';
$conf['sql']['port'] = 3306;
...
$conf['mailer']['params']['host'] = 'b1gws_postfix';
...
$conf['problems']['email'] = 'administrator@dev.localhost';
$conf['problems']['maildomain'] = 'dev.localhost';
